...
{
	public class AttachableVisualPointerTrigger : VisualAttachment, IVisualTrigger
	{
		#region Events
		...
		public static readonly DependencyProperty PointerEventProperty =
			...
			typeof(AttachableVisualPointerTrigger), new PropertyMetadata(default(PointerEventType), 
		...
		{
			if (sender is AttachableVisualPointerTrigger trigger)
			{
				try
				{
		...
		public static readonly DependencyProperty ModifiersProperty =
			...
			typeof(AttachableVisualPointerTrigger), new PropertyMetadata((VirtualKeyModifiers)uint.MaxValue));
		...
		public static readonly DependencyProperty StrictModifierCheckProperty =
			...
			typeof(AttachableVisualPointerTrigger), new PropertyMetadata(false));
