...
namespace UWPEnhanced.Controls
{
	...
	/// </summary>
	internal class EqualChildSpaceContainerPanel : Panel
	{
		...
		public new static readonly DependencyProperty FlowDirectionProperty =
			...
			typeof(EqualChildSpaceContainerPanel), new PropertyMetadata(EqualChildSpaceContainer.DefaultFlowDirection, FlowDirectionChanged));
		...
		/// </summary>
		private void ArrangeInvisibleChildren()
		{
		...
		{
			if (s is EqualChildSpaceContainerPanel panel && e.NewValue is ItemsDirection newDirection &&
